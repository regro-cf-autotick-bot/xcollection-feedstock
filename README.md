...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xcollection-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14693&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xcollection-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xcollection` can be installed with:

```
conda install xcollection
```

It is possible to list all of the versions of `xcollection` available on your platform with:
